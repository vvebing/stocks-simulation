...
const OPTION = [{
  ...
  lowPoint: '完全不怀疑',
  highPoint: '非常怀疑',
  10: '1. 交易前投资顾问选择了一支股票赠送给您，但当股票整体走势下跌时，你是否会怀疑他作出的这一选择的正确性？[单选题]',
  20: '1. 交易前您选择买入了您认为上涨概率大的股票，但当股票整体走势下跌时，你是否会怀疑自己这一选择的正确性？[单选题]',
  30: '1. 交易前投资顾问推荐给您他认为上涨概率大的几只股票，您参考了他的意见并自行买入了一只股票，但当股票整体走势下跌时，你是否会怀疑自己在他人推荐下自己作出的这一选择的正确性？[单选题]',
}, {
  key: '2',
  lowPoint: '完全没有意愿',
  highPoint: '非常有意愿',
